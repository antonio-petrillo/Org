#+title:      Decorator
#+date:       [2023-09-30 Sat 11:38]
#+filetags:   :engineering:pattern:structural:
#+identifier: 20230930T113831
...
+ As said above, you want to give additional behavior to an Object:
  ...
  + Encapsulate common behaviors for some classes and reuse them (see ~BorderDecorator~, ~ScrollDecorator~).
    This work well in combo with [[denote:20230930T111349][Composite]] pattern.
* Class Diagram
...
+ Decorator pattern is good when the class to decorate are lightweight, otherwise the [[denote:20230930T112626][Strategy]] works better.
