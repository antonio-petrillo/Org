#+title:      Iterator
#+date:       [2023-09-30 Sat 11:18]
#+filetags:   :behavioral:engineering:pattern:
#+identifier: 20230930T111852
...
** Aggregate choice
An aggreate, more likely a data structure, which expose an method to return an /Iterator/ or it could be passed to a [[denote:20230930T112014][Factory Method]] to build a new iterator based on it.
* Contract
