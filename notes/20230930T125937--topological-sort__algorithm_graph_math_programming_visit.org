...
#+date:       [2023-09-30 Sat 12:59]
#+filetags:   :algorithm:graph:math:programming:visit:
#+identifier: 20230930T125937

* TO, Topological Order or Topological Sort
...
$$T_{TO}(G) = \Theta(|V| + |E|)$$
* Algorithm 2
Another way to compute the TO is to reuse the [[denote:20230930T125726][Depth First Search]].
** Implementation
#+begin_src c
...
$$\blacksquare$$
** Time complexity
Inherit from the [[denote:20230930T125726][Depth First Search]].
