#+title:      AVL Trees
#+date:       [2023-09-30 Sat 12:46]
#+filetags:   :algorithm:datastructure:math:programming:
#+identifier: 20230930T124648

* AVL
The [[https://en.wikipedia.org/wiki/AVL_tree][AVLs]] are a class of [[denote:20230930T124422][Binary Search Tree]] that have
...
#+end_src
** The others
The same version used in a normal [[denote:20230930T124422][Binary Search Tree]] can be applied to an AVL without changes.
