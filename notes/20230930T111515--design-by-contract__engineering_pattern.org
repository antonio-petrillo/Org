...
#+date:       [2023-09-30 Sat 11:15]
#+filetags:   :engineering:pattern:
#+identifier: 20230930T111515
...
#+end_quote
This is not well defined because it isn't clear which [[math/order relationship]] the method is gonna use.
A better version is:
#+begin_quote
The method accept 2 Objects that belongs to a class that has a [[math/order relationship]]
#+end_quote
*** Method reverse
Definition:
#+begin_quote
